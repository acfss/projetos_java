...
public class MaquinadeBilhete {
	...
	public static void main(String[] args) {
		...
		local.addLocal("TCA", 100);	
		evento.addEvento("Festival de Rock", 10, 6, 2022, "Paralamas", new Local("Concha Acustica", 20), 50);
		evento.addEvento("Festival de Inverno", 15, 9, 2022, "Caetano Veloso", new Local("Went Wild", 30), 150);		
